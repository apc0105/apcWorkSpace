<template>
  <div>
    <el-table ref="table"
      ...
      <el-table-column align="center" :label="i18n('label.system.dept.code')" :width="tableColumnWidth(0.2,200)"
                       sortable column-key="code">
        <template slot-scope="scope">
          <span>{{scope.row.code}}</span>
        </template>
      </el-table-column>

      <el-table-column align="center" :label="i18n('label.system.dept.name')" :width="tableColumnWidth(0.2,200)"
      ...
      <el-table-column align="center" :label="i18n('label.system.dept.desc')">
        <template slot-scope="scope">
