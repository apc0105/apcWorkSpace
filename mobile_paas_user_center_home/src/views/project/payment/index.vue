      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline" :form="form">
          ...
          <a-row :gutter="48">
            <a-col>
              <a-form-item>
                <a-button type="primary" @click="getList" v-if="$permissionHandle('projectpayment:getList')">查询</a-button>
                <a-button @click="refresh" v-if="$permissionHandle('projectpayment:refresh')">重置</a-button>
                <!-- <a-button type="dashed" @click="bids">项目招标</a-button> -->
                <!-- <a-button type="dashed" @click="refresh">项目采购</a-button> -->
                <a-button type="dashed" @click="pact" v-if="$permissionHandle('projectpayment:pact')">项目付款</a-button>
              </a-form-item>
            </a-col>
          </a-row>
        </a-form>
