<template>
  <div>
      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline" :form="form">
          ...
          <a-row :gutter="48">
            <a-col>
              <a-form-item>
                <a-button type="primary" @click="getList" v-if="$permissionHandle('projectcontract:getList')">查询</a-button>
                <a-button @click="refresh" v-if="$permissionHandle('projectcontract:refresh')">重置</a-button>
                <a-button type="dashed" @click="bids" v-if="$permissionHandle('projectcontract:bids')">项目招标</a-button>
                <!-- <a-button type="dashed" @click="refresh">项目采购</a-button> -->
                <a-button type="dashed" @click="pact" v-if="$permissionHandle('projectcontract:pact')">项目合同</a-button>
              </a-form-item>
            </a-col>
          </a-row>
        </a-form>
    ...
    <!-- <bidsModule ref="bidsModal" :ids="ids" @getList="_getList" @noSelectChange="noSelectChange"/> -->
    <bids ref="bidsModal" :ids="ids" @getList="_getList" @noSelectChange="noSelectChange"/>
    <pactModule ref="pactModal" :ids="ids" @getList="_getList" @noSelectChange="noSelectChange" :proName="proName"/>
  </div>
</template>
<script>
...
import bids from './modules/bids'
import pactModule from './modules/pactModule'
