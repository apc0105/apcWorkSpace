<template>
  <div>
    <a-card>
          ...
          <a-row :gutter="48">
            <a-col :md="8" :sm="24">
              <a-form-item label="部门名称">
                <a-input v-model="queryParam.depName" placeholder="请输入部门名称"/>
              </a-form-item>
            </a-col>
          </a-row>
          <a-row :gutter="48">
      ...
      <edit ref="editModal" :rowss="rows" @getList="_getAreaList"/>
    </a-card>
  </div>
</template>
<script>
import edit from './modules/edit'
import { getList, deleteList } from '@/api/system/dep/index'
const columns = [{
  dataIndex: 'depName',
  key: 'depName',
  title: '部门名称',
